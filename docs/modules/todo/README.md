...
| `tenants` | Module | `claude/inspiring-clarke-GA0Ok` | Canonical 11-file doc set graduated cycle-3; 5 sprint files (00..04); `computeBusinessHours` hardened + 14 vitest tests shipped cycle-3; sprint-03 security hardening remaining |
