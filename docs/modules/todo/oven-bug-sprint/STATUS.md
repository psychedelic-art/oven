...
| 03 | Workflow engine correctness | ✅ Done (cycle-18) | `640fb5b` (test commit) | All 4 findings resolved. F-03-01 canonicalize.ts, F-03-02 transition-based loop detection, F-03-03 JSON parse guard, F-03-04 config JSON guard. +19 tests. 3 BO Integration Proposals (IP-8..10). |
