...
export default function PlanQuotaCreate() {
  return (
    <Create>
      <SimpleForm>
        ...
        <SelectInput
          ...
          isRequired
        />
        <NumberInput source="pricePerUnit" label="Overage Price Per Unit (cents)" fullWidth helperText="Price charged per unit over the quota" />
        <TextInput source="currency" label="Currency" defaultValue="COP" fullWidth />
      </SimpleForm>
    </Create>
  );
}
