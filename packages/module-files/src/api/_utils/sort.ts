 ...
 * in every list handler (see `oven-bug-sprint/sprint-05-handler-typesafety`
 * findings F-05-01 and F-05-02).
 *
 * Package-private on purpose. The helper MUST NOT be exported from
 * `packages/module-files/src/index.ts` — other modules should copy the
 * pattern (as this module did from `packages/module-ai/src/api/_utils/sort.ts`),
 * not import from `module-files`'s internals. Enforced by BO rule IP-4
 * in oven-bug-sprint sprint-05.
 */
